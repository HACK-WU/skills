---
name: expert-audit
description: 站在使用者视角审查 expert-team 产出的专家资产：零上下文用户能否看懂照用、格式是否合规（R1–R7 / CR1–CR9 / INDEX），格式问题自动修复、可读性问题给修复路径。触发："核对专家团"、"审查专家资产"、"expert audit"，或 expert-team 产出后自动触发。
---
