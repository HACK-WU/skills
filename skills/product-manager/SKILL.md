...
description: 站在产品经理视角的四模式能力：M1 需求定义（编排 requirement-mining + negative-requirement 一次成型出需求报告）、M2 已实现产品的体验走查（Kano + 价值×成本排优先级）、M3 从代码推演缺失功能、M4 前端界面视觉走查。触发："站在产品/PM 角度看看"、"还能优化什么"、"还缺什么功能"、"看看这个页面怎么样"、"帮我体验一下这个产品"、"pm 评审"。
disable: false
---
