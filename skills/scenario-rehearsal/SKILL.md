...
description: 通过模拟真实使用场景验证可行性，支持四类推演对象：设计文档（设计点可行性）、需求文档（完整性/一致性/验收可达）、Skill（触发准确性等质量维度）、代码（纸上执行追踪状态演进）。触发："推演一下这个设计/需求/skill/代码"、"模拟跑一下这个函数"、"桌面走查"，或 design-craft 完成后自动触发。
---
