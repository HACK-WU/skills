...
name: test-planner
agent_created: true
description: 读取测试来源文档，自动生成结构化测试计划。支持三种对象模式：需求文档（从 requirement.md 验收标准选策略）、设计文档（从 DESIGN.md 设计点/接口/数据流生成测试）、API 设计（从 api-design.md 契约/错误码生成测试）。根据对象特征选择测试策略，结合项目类型调整测试框架和断言方式。适用于"生成测试计划"、"写测试用例"、"test plan"、"测试文档"、"根据需求写测试"、"从设计生成测试"、"API 契约测试" 等场景。
---
