...
- **KB 原子可选**：详细知识原子按 codekb-skill 8 类白名单写 ki KB（本体，供 query 命中）；与 Step 8 专题记忆（路标）互补不重复
