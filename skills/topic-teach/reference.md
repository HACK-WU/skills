...
`stages/{N}-{阶段名}/lessons/lesson-NN-{slug}.md` 骨架。**一课含 2–5 个知识点**；首批在 Phase 1 落盘的课骨架上展开正文，若一课拆多批，第二批起在既有文件末尾**追加小节**（每小节 = 一个知识点），课首的「本课目标 / 知识点导航」首批写好，后续批次补状态，末尾「接力提示词」随批次更新指向下一批。
