...
- [ ] **实战经验与排障速查手册**（Phase 5）— pedagogy + learner 双视角 + **证据纪律核查**
...
**维护时机**：
- Phase 1 落盘时创建骨架：按阶段 → 课 → 知识点列出全部计划课（未编写 = 纯文本）+ 速览 / 手册 / 实战项目 / 实战经验 / 排障手册条目（未编写 = 纯文本）
- Phase 2 每批落盘后：对应课改为可点击链接（即成文）
- 速览完成：追加链接条目
- Phase 3 实战项目完成：实战项目条目改为可点击链接
- Phase 4 手册完成：追加链接条目
- Phase 5 经验与手册完成：实战经验 / 排障手册两条目改为可点击链接
...
- **避坑**：复制"给我讲讲 {主题} 的实战经验与排障手册"，进入 Phase 5。
