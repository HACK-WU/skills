---
name: harness-review
description: 对项目的 AI 编码工作流（Harness）做轻量体检：从任务理解、受控执行、变更验证、可靠交付、学习沉淀五个维度评估机制是否存在与真正被使用，产出带证据状态标注的报告（纯 Markdown，零运行时依赖）。触发："体检一下工作流"、"评估 AI 工作流"、"harness review"。
---
