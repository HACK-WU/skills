---
name: challenger
description: 质疑者，专门寻找评审可能遗漏的问题。支持对代码变更和设计文档进行二次质疑，发现潜在风险。代码变更支持三种质疑策略（Bug修复类、新增功能类、优化类），设计文档支持设计文档质疑策略。触发短语包括：'质疑这个修复'、'挑战这个代码'、'二次审查'、'还有其他问题吗'、'这个修复真的没问题吗'、'质疑这个设计'、'挑战这个方案'、'这个设计真的没问题吗'。
---
