...
| **[performance-analysis](./skills/performance-analysis/SKILL.md)** | 接口/请求链路性能专项分析：盘点现有证据（火焰图/APM/压测/慢查询）与代码，八层定位瓶颈，量化收益上限与优先级，产出面向开发或产品的报告 + 验证计划 | "性能分析"、"为什么这么慢"、"接口 RT 高"、"性能优化"、"出份性能报告"、"容量评估" |
